...
public class MyWorld implements World {
    private static final int MAX_TIME = 60 * 1000; // 1 minute
    private int score = 0;
    ...
    private static MyWorld myWorld=null;
    private Strategy speedStrategy;
    private MyWorld() {
        constant.add(new BackGround(0,0, "/View/ff.jpg"));
        creationTime=System.currentTimeMillis()-timeDelay;
        createPlate();
        control.add(new ShapeFactory().createShape(width/3,(int)(height*0.7), "/View/Clown.png", ShapeType.Clown));
    }
    ...
    private void createPlate() {
        ...
        switch (rand) {
            case 1:
                moving.add(factory.createShape((int) (Math.random() * (width - 100)), -50, "/View/redplate2.png", ShapeType.REDPLATE));
                break;
            case 2:
                moving.add(factory.createShape((int) (Math.random() * (width - 100)),  -50, "/View/blueplate.png", ShapeType.BLUEPLATE));
                break;
            case 3:
                moving.add(factory.createShape((int) (Math.random() * (width - 100)),  -50, "/View/greenplate.png", ShapeType.GREENPLATE));
                break;
            case 4:
                moving.add(factory.createShape((int) (Math.random() * (width - 100)),  -50, "/View/bomb.png", ShapeType.BOMB));
                break;
        }
